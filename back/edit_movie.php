...
<div class="grey0 p-10">
    <div class="rb ct title">修改電影資料</div>
    ...
    <form action="./api/edit_movie.php" method="post" enctype="multipart/form-data">
            ...
            <div class="grey1 w-60 p-10 ">
                <table class="w-100">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="name" id="name" style="width: 98%;" value="<?=$movie['name']?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="time" id="time" style="width: 98%;" value="<?=$movie['time']?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="pub" id="pub" style="width: 98%;" value="<?=$movie['pub']?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="dir" id="dir" style="width: 98%;" value="<?=$movie['dir']?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
        ...
        <div class="d-f j-c my-10">
            ...
            <div class="grey1 w-60 p-10 ">
                <textarea name="intro" id="intro" style="width: 98%;"><?=$movie['intro']?></textarea>
            </div>
        </div>
