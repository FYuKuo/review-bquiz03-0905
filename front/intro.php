...
<div class="tab rb" style="width:87%;">
    <div style="background:#FFF; width:100%; color:#333; text-align:left">
        <video src="./upload/<?= $movie['movie'] ?>" width="300px" height="250px" controls="" style="float:right;"></video>
        <font style="font-size:24px"> <img src="./upload/<?= $movie['img'] ?>" width="200px" height="250px" style="margin:10px; float:left">
            ...
            <p style="margin:3px">影片分級 ： <img src="./icon/03C0<?= $movie['type'] ?>.png" style="display:inline-block;"><?= $type ?>
            </p>
